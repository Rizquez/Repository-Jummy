...
a38a16d0-767a-11eb-abe2-cecd029e558e:1-496213986';
...
CREATE TABLE `pedidos` (
  ...
  `id_comensales` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pedidos_comensales1_idx` (`id_comensales`),
  CONSTRAINT `fk_pedidos_comensales1` FOREIGN KEY (`id_comensales`) REFERENCES `comensales` (`id`)
...
-- Dump completed on 2024-12-12  1:22:04
